...
(function(){
  ...
  const RAW=[
   ["김도은","와트팜","https://wattfarm.vercel.app/","태양광 발전소를 1만 원 단위로 함께 소유하고 매월 배당을 받는 B2C 에너지 투자 서비스.","금융",C.fin,"☀️","태양광 발전소를 함께 소유하고 매월 배당받기"],
   ["박세현","SoloFin","https://solofin.vercel.app/login","1인 창업가를 위한 수익·지출 관리 앱. 혼자 사업하는 사람의 돈 흐름을 빈틈없이 정리해줘요.","금융",C.fin,"💰","1인 창업가를 위한 수익·지출 관리 앱"],
   ["윤상호","S2 트레이딩 따라하기","https://s2-trading-web.vercel.app/dashboard","내가 정한 매도 룰북대로 종목을 자동 감시하고, 매수 후보 종목군까지 자동으로 검출해주는 주식 매매 보조 서비스.","금융",C.fin,"📈","내 매도 룰 자동 감시 + 매수 후보 검출"],
   ["김민건","내 책 취향 찾기","https://book-taste-finder.vercel.app/","책 커버 사진 한 장이면 어떤 책인지 분석해, 구매 전에 이 책이 나와 맞는지 알려주는 서비스.","독서",C.book,"📚","책 커버 한 장으로, 나와 맞는 책인지 확인"],
   ["곽희진","오늘의 한끼","https://freeium-app.vercel.app/","냉장고 속 재료로 만들 수 있는 메뉴를 추천해주는 앱.","라이프",C.life,"🍳","냉장고 속 재료로 만드는 오늘의 메뉴"],
   ...
   ["장세희","사이(Between)","https://my-project-one-gray.vercel.app/intro","감정과 행동 사이의 6초를 잡아주는, 부모를 위한 AI 페어런팅 코치. 욱하는 순간 내 패턴을 알면 달라져요.","반려·가족",C.care,"🧘","부모를 위한 AI 감정 코치, 그 6초"],
   ["박준홍","ChefNote","https://chefnote.kr/","조리학과 학생을 위한 AI 수업 노트. 녹음만 하면 재료·조리 순서·교수님 팁까지 자동으로 정리돼요.","교육·커리어",C.edu,"🎙️","녹음만 하면 수업 노트가 알아서 완성"],
   ["박혜준","아빠나야","https://dad-companion.vercel.app/family","아빠의 눈이 되어 드리는 AI 도우미.","반려·가족",C.care,"👶","아빠의 눈이 되어 드릴 AI 도우미"],
   ["백일선","성분탐정","https://pet-food-app-3862.vercel.app/","바코드 스캔이나 제품명 검색으로 반려동물 사료의 원재료와 영양 성분을 분석해주는 서비스.","반려·가족",C.care,"🐾","우리 아이 사료, 성분이 괜찮을까?"],
   ["박주연","페이지메이트","https://pagemate.vercel.app/login","책 한 권으로 연결되는 독서모임 서비스. 같은 책을 읽는 사람들과 만나 생각을 나눠요.","독서",C.book,"📖","책 한 권으로 연결되는 독서모임"],
   ...
   ["홍주연","다이어트 탐정","https://my-todo-app-three-woad.vercel.app/","식습관·감정·패턴을 추적해 살이 안 빠지는 진짜 이유를 찾아주는 퍼스널 다이어트 진단 서비스.","건강·자기계발",C.health,"🥗","살이 안 빠지는 진짜 이유를 진단"],
   ["임원호","NCS 채용 매칭","https://ncs-job-matching-kr.surge.sh/","NCS 기반으로 내게 맞는 채용 공고를 매칭해주는 서비스.","교육·커리어",C.edu,"💼","NCS 기반 맞춤 채용 매칭"],
   ["김재민","MoaTime","https://moatime.vercel.app/","로그인 없이 PIN 번호로 모두의 가능한 시간을 모아 간편하게 일정을 잡는 서비스.","생산성",C.prod,"🗓️","로그인 없이 PIN으로, 일정 잡기"],
   ["홍영택","부스트업","https://boost-up-ten.vercel.app/","매일 한 줄 명언으로 하루의 동기를 채워주는 데일리 명언 서비스.","건강·자기계발",C.health,"🚀","매일 한 줄 명언으로 시작하는 하루"],
   ["박찬성","Chession","https://chess-puzzle-v2.vercel.app/","체스 학원 학생과 독학자를 위한 테마별 퍼즐 트레이너. 틀린 문제를 자동 복습하고 풀이 시간으로 성장을 기록해요.","교육·커리어",C.edu,"♟️","테마별 체스 퍼즐로 실력 키우기"],
   ...
   ["홍지혜","다온","https://daon-chi.vercel.app/dashboard","목표를 잃어도 다시 돌아올 수 있게, 곁에서 기억하고 먼저 찾아오는 퍼스널 AI 목표 코치.","건강·자기계발",C.health,"🌱","다시 돌아오게 하는 AI 목표 코치"],
   ...
   ["남현주","이자세이버","https://hyunju9056-interest-saver.vercel.app/","대출 갈아타기 계산으로 이자를 아껴주는 알리미. 더 나은 조건을 찾아 이자를 줄여줘요.","금융",C.fin,"🏦","이자 아껴주는 대출 갈아타기 알리미"],
   ...
   ["김유진","책린이 독서 트래커","https://my-project-book-pi.vercel.app/","내 손안의 작은 도서관. 읽은 책을 기록하고 완독까지 도와주는 퍼스널 독서 기록 서비스.","독서",C.book,"📖","내 손안의 작은 도서관, 독서 기록"],
   ["김세림","키잇 (Key-it)","https://key-it-tau.vercel.app/","서울·경기 방탈출 매장의 테마·시간대·잔여석을 한 화면에서 비교하고 바로 예약하는 서비스.","라이프",C.life,"🔑","방탈출, 한 화면에서 비교하고 예약"],
   ["김수민","BOXCARD","https://my-boxcard-app.vercel.app/","복서를 위한 운동 기록 커뮤니티. 꾸준함과 성장을 카드로 기록해요.","라이프",C.life,"🥊","복서를 위한 운동 기록 커뮤니티"],
   ["임선주","점메추","https://jeommechu-chi.vercel.app/","오늘 점심 뭐 먹지? 직장인의 점심 메뉴 고민을 대신 해결해주는 추천 서비스.","라이프",C.life,"🍚","직장인의 점심 메뉴 추천"],
   ["이다은","KBO 직관 메이트","https://kbo-ticket.vercel.app/","10구단 경기 일정을 한눈에 보고, 홈팀 예매처로 바로 연결해주는 야구 직관 메이트.","라이프",C.life,"⚾","10구단 일정 한눈에, 예매처 바로가기"],
   ["강보연","멍냥별점","https://mungnyang-stars.vercel.app/","오늘 우리 아이의 별점은? 반려동물을 위한 따뜻한 일일 운세·궁합 서비스.","반려·가족",C.care,"🔮","우리 아이의 오늘 별점은?"],
   ["정효균","내보증","https://naebojeung.vercel.app/","업종·매출·업력·지역·신용등급을 입력하면 AI가 정부 지원정책·보증상품·대출상품을 한 번에 매칭해주는 소상공인 금융 매칭 서비스.","금융",C.fin,"🏦","소상공인 정책·보증·대출 한 번에 매칭"],
