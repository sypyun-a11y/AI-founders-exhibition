...
(function(){
  ...
  const RAW=[
   ...
   ["김민건","내 책 취향 찾기","https://book-taste-finder.vercel.app/","마음에 드는 책 표지 한 장만 찰칵 찍어보세요. 구매하기 전, 이 책이 정말 나와 결이 맞는지 깊이 분석해주는 나만의 스마트한 북 가이드. 실패 없는 독서의 시작점을 경험해보세요.","독서",C.book,"📚","책 커버 한 장으로, 나와 맞는 책인지 확인"],
   ...
   ["장세희","사이(Between)","https://my-project-one-gray.vercel.app/intro","“또 아이에게 소리를 질렀네…” 밤마다 자책하며 후회하는 부모를 위해, 단 30초의 기록으로 AI가 당신의 숨은 감정 트리거 패턴을 분석하고 다음 폭발 직전 ‘6초의 틈’을 만들어주는 실시간 육아 멘토예요.","반려·가족",C.care,"🧘","부모를 위한 AI 감정 코치, 그 6초"],
   ...
   ["박혜준","아빠나야","https://dad-companion.vercel.app/family","24시간 독박 돌봄으로 지쳐가는 가족을 위해, 가정을 지키는 다정한 AI 도우미가 찾아옵니다. 눈과 귀가 어두운 90세 어르신의 끝없는 반복 질문을 AI가 대신 대답해 주고, 자녀의 안부 메시지와 일정을 목소리로 먼저 전하며, 돌봄 가족에게는 휴식을 어르신에게는 인지 자극을 선물하는 가장 따뜻한 기술을 만나보세요.","반려·가족",C.care,"🧓","시각장애·고령 어르신 돌봄 가족을 위한 AI 도우미"],
   ["백일선","성분탐정","https://pet-food-app-3862.vercel.app/","말 못 하는 우리 아이가 매일 먹는 사료, 정말 안심하고 먹여도 될까요? 복잡한 화학 성분과 원재료를 투명하게 분석해 내 아이의 건강 상태에 딱 맞는 사료를 골라주는, 반려인을 위한 과학적인 건강 가이드.","반려·가족",C.care,"🐾","우리 아이 사료, 성분이 괜찮을까?"],
   ...
   ["이정화","약플로(Yakflo)","https://ehwaa.com/","복잡한 기관 등록이나 약사 자격 없이도, 바코드 스캔 한 번으로 의약품의 유효기한과 재고를 한 번에 관리하는 솔루션. 일반 직원도 저렴한 비용으로 수동 관리의 실수를 제로로 만드는 병·약국 맞춤형 스마트 치트키.","생산성",C.prod,"💊","바코드로 유효기한·재고를 한 번에"],
   ...
   ["박근형","로카이","https://review-marketing-ten.vercel.app/login","리뷰 분석을 통한 자동 댓글부터 사진 몇 장으로 쇼츠 제작·자동 업로드까지 알아서 척척 해내는 사장님 전용 AI 직원. 비싼 인건비와 홍보 부담은 걷어내고, 유입부터 재방문 유도까지 마케팅의 모든 과정을 자동화해보세요.","마케팅",C.mkt,"🏪","최저시급보다 저렴한 우리가게 AI 직원"],
   ...
   ["임선주","점메추","https://jeommechu-chi.vercel.app/","매일 점심시간마다 찾아오는 지독한 결정장애를 단번에 날려주는 직장인 맞춤형 맛집 추천 서비스.","라이프",C.life,"🍚","직장인의 점심 메뉴 추천"],
  ...
  const COVER={
    ...
    8:{bg:"#0b0b0d",rainbow:true,dark:true,name:"아빠, 나야",sub:"어르신 돌봄 가족을 위한 다정한 AI 도우미"},
